...
import cn.edu.gdmec.android.boxuegu02.Activity.LoginActivty;
import cn.edu.gdmec.android.boxuegu02.Activity.SettingActivity;
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_course_history:
                if (AnalysisUtils.readLoginStatus(getActivity())){
                    ...
                    Toast.makeText(getActivity(),"您未登录，请先登陆",Toast.LENGTH_SHORT).show();
                }
                break;
