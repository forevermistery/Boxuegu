...
import cn.edu.gdmec.android.boxuegu.bean.CourseBean;package cn.edu.gdmec.android.boxuegu.adapter;
...
public class CourseListItemAdapter extends RecyclerView.Adapter<cn.edu.gdmec.android.boxuegu.adapter.CourseListItemAdapter.ViewHolder> {
    ...
    @Override
    public cn.edu.gdmec.android.boxuegu.adapter.CourseListItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.course_list_item,parent,false);

        return new cn.edu.gdmec.android.boxuegu.adapter.CourseListItemAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(cn.edu.gdmec.android.boxuegu.adapter.CourseListItemAdapter.ViewHolder viewHolder, int postion){
        initializeViews(objects.get(postion),viewHolder);
    }
...
//    }
    ...
    private void initializeViews(CourseBean object, cn.edu.gdmec.android.boxuegu.adapter.CourseListItemAdapter.ViewHolder holder) {
        if (object !=null){
